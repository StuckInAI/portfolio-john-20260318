    ...
    <footer className="bg-slate-900 text-white">
      <div className="container-max section-padding">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
          {/* Brand */}
          <div>
            <div className="text-2xl font-black gradient-text mb-4">AJ.</div>
            ...
            <div className="flex gap-3">
              {socialLinks.map((social) => (
                <a
                  ...
                  className="w-10 h-10 bg-slate-800 rounded-lg flex items-center justify-center text-slate-400 hover:bg-primary-600 hover:text-white transition-all duration-200"
                >
                  {social.icon}
                </a>
              ))}
          ...
          {/* Contact */}
          <div>
            <h3 className="font-semibold text-white mb-4 uppercase tracking-wider text-sm">Get In Touch</h3>
